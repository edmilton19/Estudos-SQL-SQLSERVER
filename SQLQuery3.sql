...
ALTER TABLE CLIENTES ADD CONSTRAINT PK_CPF
...
INSERT INTO [PRODUTOS] ([CODIGO PRODUTO], [NOME PRODUTO], [EMBALAGEM], [TAMANHO], [PRECO DE LISTA], [SABOR])
VALUES
...
INSERT INTO [PRODUTOS] ([CODIGO PRODUTO], [NOME PRODUTO], [EMBALAGEM], [TAMANHO],[SABOR],[PRECO DE LISTA])
VALUES
...
SELECT NOME AS [NOME DO CLIENTE], CPF, ESTADO AS UF FROM CLIENTES
ORDER BY [NOME];

SELECT MATRICULA AS IDENTIFICADOR, NOME AS [NOME DO VENDEDOR] FROM VENDEDORES;

SELECT SABOR FROM PRODUTOS;
